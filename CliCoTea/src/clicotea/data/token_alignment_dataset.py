...
class TokenAlignmentDataset(Dataset):
    def __init__(
        ...
        src_tokenizer_name: str = "openai/clip-vit-base-patch16",
        ...
        # self.src_tokenizer = CLIPTokenizerFast.from_pretrained(src_tokenizer_name)
    ...
    def __getitem__(self, idx): #将词汇对应关系改为token_id对应关系pair
